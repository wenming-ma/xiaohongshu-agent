...
@pytest.mark.parametrize(
    ("raw", "expected_count", "expected_single", "expected_styles"),
    [
        (
...
def test_free_text_requirement_matrix(raw: str, expected_count: int | None, expected_single: bool, expected_styles: set[str]) -> None:
    ...
    assert expected_styles.issubset(set(request.style_constraints))
