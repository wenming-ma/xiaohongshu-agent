...
## ⚠️ 商业实体名称模糊处理（所有帖子必须遵守！）
内容中涉及的**商业产品名、品牌名、店铺名**等商业实体名称，必须进行模糊处理：
- 用 **X** 或 **\*** 替换名称中的部分文字
...
**⚠️ 商业实体名称模糊处理**：帖子中的商业产品名/品牌名/店铺名需用X或*替换部分文字（如：星*克、海*捞）；地名、人名、公共机构等非商业实体无需模糊
...
- [ ] **商业实体模糊处理**：商业产品名/品牌名/店铺名是否已用X或*做模糊处理？（地名、人名、公共机构等无需模糊）
