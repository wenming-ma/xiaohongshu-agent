...
class MasterAgent(BaseAgent):
    ...
    def init_tools(self) -> None:
        """加载所有已注册的平台流水线"""
        from ..agents import register_pipelines

        register_pipelines()

        self.platform_tools = PipelineRegistry.get_pydantic_tools()
    ...
    def _build_system_prompt(self) -> str:
        """构建系统提示词"""
        tool_descriptions = PipelineRegistry.get_pipeline_descriptions()
