...
class ImageConfig:
    ...
    MAX_AUTO_IMAGES = int(os.getenv("IMAGE_MAX_AUTO_IMAGES", "9"))
    GENERATION_CONCURRENCY = int(os.getenv("IMAGE_GENERATION_CONCURRENCY", "3"))
    ...
    ENABLE_LOCAL_PROMPT_TEMPLATES = _bool_env("ENABLE_LOCAL_PROMPT_TEMPLATES", True)
...
class ResearchConfig:
    ...
    MAX_NEW_POSTS_PER_ITERATION = int(os.getenv("RESEARCH_MAX_NEW_POSTS_PER_ITERATION", "3"))
    PER_ITERATION_REQUEST_LIMIT = int(os.getenv("RESEARCH_PER_ITERATION_REQUEST_LIMIT", "30"))
    PER_ITERATION_TOOL_CALLS_LIMIT = int(os.getenv("RESEARCH_PER_ITERATION_TOOL_CALLS_LIMIT", "60"))
    POST_IMAGE_READER_MAX_IMAGES = int(os.getenv("RESEARCH_POST_IMAGE_READER_MAX_IMAGES", "3"))
    POST_IMAGE_READER_REQUEST_LIMIT = int(os.getenv("RESEARCH_POST_IMAGE_READER_REQUEST_LIMIT", "8"))
    POST_IMAGE_READER_TOOL_CALLS_LIMIT = int(os.getenv("RESEARCH_POST_IMAGE_READER_TOOL_CALLS_LIMIT", "12"))


class ArticleResearchConfig:
    MIN_SOURCE_PAGES = int(os.getenv("ARTICLE_RESEARCH_MIN_SOURCE_PAGES", "8"))
    MIN_UNIQUE_DOMAINS = int(os.getenv("ARTICLE_RESEARCH_MIN_UNIQUE_DOMAINS", "6"))
    MAX_SOURCE_PAGES = int(os.getenv("ARTICLE_RESEARCH_MAX_SOURCE_PAGES", "10"))
    MAX_VIDEO_TRANSCRIPTS = int(os.getenv("ARTICLE_RESEARCH_MAX_VIDEO_TRANSCRIPTS", "2"))
    MAX_ITERATIONS = int(os.getenv("ARTICLE_RESEARCH_MAX_ITERATIONS", "3"))
    SEARCH_CONCURRENCY = int(os.getenv("ARTICLE_RESEARCH_SEARCH_CONCURRENCY", "3"))
    PAGE_VISIT_CONCURRENCY = int(os.getenv("ARTICLE_RESEARCH_PAGE_VISIT_CONCURRENCY", "3"))
    MAX_TASKS_PER_ITERATION = int(os.getenv("ARTICLE_RESEARCH_MAX_TASKS_PER_ITERATION", "4"))
    MIN_CURATION_QUALITY_SCORE = float(os.getenv("ARTICLE_RESEARCH_MIN_CURATION_QUALITY_SCORE", "72"))
    MAX_CURATED_SOURCES_PER_TASK = int(os.getenv("ARTICLE_RESEARCH_MAX_CURATED_SOURCES_PER_TASK", "3"))
    MAX_CURATED_VIDEO_SOURCES_PER_TASK = int(os.getenv("ARTICLE_RESEARCH_MAX_CURATED_VIDEO_SOURCES_PER_TASK", "2"))
    MIN_CURATED_SOURCES_FOR_NOTE_COMPRESSION = int(os.getenv("ARTICLE_RESEARCH_MIN_CURATED_SOURCES_FOR_NOTE_COMPRESSION", "2"))
    MIN_DIGESTS_FOR_FULL_SYNTHESIS = int(os.getenv("ARTICLE_RESEARCH_MIN_DIGESTS_FOR_FULL_SYNTHESIS", "2"))
    INCLUDE_MIXED_VIDEO_QUERIES = _bool_env("ARTICLE_RESEARCH_INCLUDE_MIXED_VIDEO_QUERIES", False)
    VIDEO_MAX_FILESIZE_MB = int(os.getenv("ARTICLE_RESEARCH_VIDEO_MAX_FILESIZE_MB", "30"))


class ArticleContentConfig:
    MAX_ITERATIONS = int(os.getenv("ARTICLE_CONTENT_MAX_ITERATIONS", str(ReviewConfig.MAX_ITERATIONS)))


class ArticleImageConfig:
    MAX_IMAGES = int(os.getenv("ARTICLE_IMAGE_MAX_IMAGES", "3"))
