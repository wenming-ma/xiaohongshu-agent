...
class XHSArticlePostPipeline(BasePipeline[XHSArticlePostInput, XHSArticlePostOutput]):
...
"""
    ...
    async def execute(self, input_data: XHSArticlePostInput) -> XHSArticlePostOutput:
        ...
        logger.info("=" * 60)
        logger.info("XHSArticlePostPipeline 开始执行")
        logger.info("=" * 60)
        ...
        try:
            ...
            logger.info("=" * 60)
            logger.info("XHSArticlePostPipeline 执行完成")
            logger.info("=" * 60)
            ...
            logger.error("XHSArticlePostPipeline 执行失败: %s", exc)
            import traceback
