...
3. **Reasonable Duration**
   - 30 seconds - 10 minutes is ideal
...
4. Click "Filters" and select "Short (under 4 minutes)" or "Medium (4-20 minutes)" under Duration, but only pick videos under 10 minutes
...
- Is the duration reasonable (30 seconds-10 minutes)?
