...
class IndexTTS2:
    def __init__(
        ...
        emo_matrix = torch.load(os.path.join(self.model_dir, self.cfg.emo_matrix), weights_only=False)
        self.emo_matrix = emo_matrix.to(self.device)
        self.emo_num = list(self.cfg.emo_num)

        spk_matrix = torch.load(os.path.join(self.model_dir, self.cfg.spk_matrix), weights_only=False)
